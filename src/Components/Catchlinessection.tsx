...
export default function CatchLinesSection() {
  ...
  const newBadgeColor = darkMode ? "#FF007A" : "#ea580c";

  return (
    <section ref={ref} className="w-full overflow-hidden">

      {/* ── Top: Background image area — same dono modes mein ── */}
      <div
      ...
      {/* ── Bottom: Info banner — gradient switch hoga ── */}
      <div
        className="w-full mt-6 py-4 px-6 flex flex-col sm:flex-row items-center justify-center gap-4"
        style={{
      ...
      >
        ...
        <div className="flex items-center gap-3">
          <span
            className="text-white text-[10px] font-extrabold px-2 py-0.5 rounded-full uppercase tracking-wider"
